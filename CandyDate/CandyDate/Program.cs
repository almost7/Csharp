...
namespace CandyDate
{
    class Program
    {
        ...
        {
            StreamReader candidaturas = new StreamReader(@"E:\Programação\C-\CandyDate\CandyDate\candidatos.txt", Encoding.GetEncoding("iso-8859-1"));
        ...
        {
            StreamWriter candidaturas = new StreamWriter(@"E:\Programação\C-\CandyDate\CandyDate\candidatos.txt", opcao, Encoding.GetEncoding("iso-8859-1"));
